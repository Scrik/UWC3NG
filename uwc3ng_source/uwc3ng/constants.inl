...
new const Skill_Max_Points[MAX_SKILLS] = { 5, 3, 5, 7, 3, 6, 3, 7,		// Page 1
	6, 1, 3, 7, 6, 8, 5, 7, 						// Page 2
	6, 1, 10, 1, 10, 1, 10, 5,						// Page 3
	10, 1, 1, 10, 3, 1, 10, 1,						// Page 4
	1, 1, 1, 1, 1, 3, 5, 10 };						// Page 5

// Skill const
new const Float:p_ankh[3] = { 0.333, 0.666, 1.0 }; // Equipment reincarnation
new const Float:p_impale[5] = { 0.05, 0.10, 0.15, 0.20, 0.25 }; // Impale
new const p_devotion[7]  = { 10, 20, 30, 35, 40, 45, 50 }; // Devotion Aura
new const Float:p_heal[3] = { 6.0, 4.0, 2.0 }; // Healing Wave
new const Float:p_mana[6] = { 0.03, 0.05, 0.07, 0.09, 0.11, 0.13 }; // Siphon Mana
new const Float:p_lskin[3] = { 6.0, 4.0, 2.0 }; // Leather Skin
new const Float:p_vampiric[7] = { 0.08, 0.11, 0.14, 0.17, 0.20, 0.23, 0.26 }; // Vampiric Aura
new const Float:p_spiked[6] = { 0.06, 0.10, 0.14, 0.18, 0.22, 0.26 }; // Spiked Carapace
new const Float:p_unholy[7] = { 265.0, 272.5, 280.0, 287.5, 295.0, 302.5, 310.0 }; // Unholy Aura
new const Float:p_hex[6] = { 0.04, 0.08, 0.12, 0.16, 0.20, 0.24 }; // Hex
new const Float:p_bash[8] = { 0.03, 0.06, 0.09, 0.12, 0.15, 0.18, 0.21, 0.24 }; // Bash
new const p_serpent[5] = { 1, 2, 3, 4, 5 }; // Serpent Ward
new const Float:p_banish[7] = { 0.06, 0.09, 0.12, 0.15, 0.18, 0.20, 0.22 }; // Banish
new const Float:p_thorns[6] = { 0.1, 0.15, 0.2, 0.25, 0.3, 0.35 }; // Thorns Aura  
...
new const Float:p_steel[7] = { 0.08, 0.11, 0.14, 0.17, 0.20, 0.23, 0.26 }; // Steel Skin
...
new const Float:p_phoenix[3] = { 0.33, 0.66, 1.00 } // Pheonix
new const Float:p_armor[10]  = { 0.04, 0.06, 0.08, 0.10, 0.13, 0.16, 0.19, 0.21, 0.24, 0.28 }; // Siphon Armor
new const Float:p_levitation[5] = { 0.8, 0.7, 0.60, 0.5, 0.4 }; // Levitation
new const Float:p_fan[3] = { 0.03, 0.06, 0.09 }; // Fan of Knives
